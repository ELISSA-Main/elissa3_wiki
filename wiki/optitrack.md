...
2. Reset the application settings (Edit > Reset Application Settings). <img src="graphics/reset calibration.png" alt="Reset Calibration" width="400">
3. Then go to "Application Settings" pane and set the "Continuous Calibration" setting as "Continuous". <img src="graphics/application settings.png" alt="Application Settings" width="300"> <img src="graphics/continuous calibration.png" alt="Continuous Calibration" width="600">
